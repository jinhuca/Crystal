...
namespace Crystal.Unity
{
	...
	public static class IocExtensions
	{
		...
		public static IUnityContainer GetContainer(this IContainerProvider containerProvider) => ((IContainerExtension<IUnityContainer>)containerProvider).Instance;
		...
		/// <returns>The underlying <see cref="IUnityContainer" /></returns>
		public static IUnityContainer GetContainer(this IContainerRegistry containerRegistry) => ((IContainerExtension<IUnityContainer>)containerRegistry).Instance;
	}
}
