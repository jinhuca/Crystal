...
public class MemoryErrorAndSensorsTests
{
    ...
    public void Decode_MemoryError32_DecodesAddressesAndSyndrome()
    {
        ...
        var obj = (Crystal.Smbios.Types.T018_MemoryErrorInformation32)table.MemoryErrorInformation.First();
    ...
    public void Decode_MemoryError64_DecodesQWordAddresses()
    {
        ...
        var obj = (Crystal.Smbios.Types.T033_MemoryErrorInformation64)table.MemoryErrorInformation.First();
    ...
    public void Decode_SystemPowerSupply_Basic()
    {
        ...
        Assert.Equal(Crystal.Smbios.Types.PowerSupplyType.Switching, ps.SupplyType);
        Assert.Equal(Crystal.Smbios.Types.PowerSupplyStatus.OK, ps.Status);
