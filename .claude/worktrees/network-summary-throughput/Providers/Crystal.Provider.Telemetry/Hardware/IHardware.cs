...
public interface IHardware : IElement {
  /// <summary>
  /// <inheritdoc cref="Crystal.Provider.Telemetry.Hardware.HardwareType"/>
  /// </summary>
  ...
  /// <summary>
  /// Gets child devices, e.g. <see cref="Crystal.Provider.Telemetry.Hardware.Motherboard.Lpc.LpcIO"/> of the <see cref="Crystal.Provider.Telemetry.Hardware.Motherboard.Motherboard"/>.
  /// </summary>
