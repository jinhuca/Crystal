...
[
  ...
  public static unsafe void Open() {
    ...
    if (IntPtr.Size == 4) {
      ...
      rdTscCode = Rdtsc64;
      cpuidCode = Crystal.Provider.Telemetry.Software.OperatingSystem.IsUnix ? CpuId64Linux : CpuId64Windows;
    }
    ...
    lock (_syncLock) {
      ...
      if (Crystal.Provider.Telemetry.Software.OperatingSystem.IsUnix) {
#if NETFRAMEWORK
