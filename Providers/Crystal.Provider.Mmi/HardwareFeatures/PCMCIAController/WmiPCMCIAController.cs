...
namespace Crystal.Provider.Mmi.HardwareFeatures.PCMCIAController;

internal static class WmiPCMCIAController {
  // ---------------------------------------------------------------------
  // WMI Class
  // ---------------------------------------------------------------------
  public const string ClassName = WmiClasses.PCMCIAController;
  ...
  // ---------------------------------------------------------------------
  // PCMCIA Controller (CIM_Controller) Specific Properties
  // ---------------------------------------------------------------------
