using Crystal.Telemetry.Hardware.Motherboard.Lpc;
using Crystal.Telemetry.Hardware.Motherboard.Lpc.EC;
using System;
...
public class Motherboard : IHardware {
  ...
  /// <summary>
  /// Creates motherboard instance by retrieving information from <see cref="Crystal.Telemetry.Hardware.SMBios" /> and creates a new <see cref="SubHardware" /> based on data from <see cref="LpcIO" />
  /// and <see cref="EmbeddedController" />.
  /// </summary>
  /// <param name="smBios"><see cref="Crystal.Telemetry.Hardware.SMBios" /> table containing motherboard data.</param>
...
#pragma warning restore 67
  ...
  /// <summary>
  /// Gets the <see cref="Crystal.Telemetry.Hardware.Motherboard.Manufacturer" />.
  /// </summary>
  public Manufacturer Manufacturer { get; }

  /// <summary>
  /// Gets the <see cref="Crystal.Telemetry.Hardware.Motherboard.Model" />.
  /// </summary>
  public Model Model { get; }

  /// <summary>
  /// Gets the name obtained from <see cref="Crystal.Telemetry.Hardware.SMBios" />.
  /// </summary>
  public string Name {
  ...
  /// <summary>
  /// Gets the <see cref="Crystal.Telemetry.Hardware.SMBios" /> information.
  /// </summary>
