...
public interface IHardware : IElement {
  /// <summary>
  /// <inheritdoc cref="Crystal.Telemetry.Hardware.HardwareType"/>
  /// </summary>
  ...
  /// <summary>
  /// Gets child devices, e.g. <see cref="Crystal.Telemetry.Hardware.Motherboard.Lpc.LpcIO"/> of the <see cref="Crystal.Telemetry.Hardware.Motherboard.Motherboard"/>.
  /// </summary>
