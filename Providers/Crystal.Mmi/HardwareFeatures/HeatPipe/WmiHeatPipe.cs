...
namespace Crystal.Mmi.HardwareFeatures.HeatPipe;

internal static class WmiHeatPipe {
  // ---------------------------------------------------------------------
  // WMI Class
  // ---------------------------------------------------------------------
  public const string ClassName = "Win32_HeatPipe";
