...
namespace Crystal.Mmi.HardwareFeatures.IDEController;

internal static class WmiIDEController {
  // ---------------------------------------------------------------------
  // WMI Class
  // ---------------------------------------------------------------------
  public const string ClassName = WmiClasses.IDEController;
  ...
  // ---------------------------------------------------------------------
  // IDE Controller Specific Properties
  // ---------------------------------------------------------------------
