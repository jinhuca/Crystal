...
namespace Crystal.Mmi.HardwareFeatures.TemperatureProbe;

internal static class WmiTemperatureProbe {
  // ---------------------------------------------------------------------
  // WMI Class
  // ---------------------------------------------------------------------
  public const string ClassName = WmiClasses.TemperatureProbe;
  ...
  // ---------------------------------------------------------------------
  // Temperature Probe Specific Properties
  // ---------------------------------------------------------------------
