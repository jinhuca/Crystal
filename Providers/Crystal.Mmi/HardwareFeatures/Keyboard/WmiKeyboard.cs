...
internal static class WmiKeyboard {
  // ---------------------------------------------------------------------
  // WMI Class
  // ---------------------------------------------------------------------
  public const string ClassName = WmiClasses.Keyboard;
  ...
  public const string NumberOfFunctionKeys = nameof(NumberOfFunctionKeys);
