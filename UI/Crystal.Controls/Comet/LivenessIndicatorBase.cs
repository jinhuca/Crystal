...
public abstract class LivenessIndicatorBase : UserControl {
  /// <summary>
  /// Initializes a new instance of the <see cref="LivenessIndicatorBase"/> class.
  /// </summary>
  ...
  /// <summary>
  /// Rebuild the visual tree and (re)start the animation.
  /// </summary>
  protected abstract void Rebuild();

  /// <summary>
  /// Detach the running animation clocks.
  /// </summary>
  ...
  /// <summary>
  /// The base color of the comet. The head is fully saturated, and the tail fades to transparent.
  /// </summary>
  public static readonly DependencyProperty ColorProperty = DependencyProperty.Register(
    nameof(Color),
    typeof(Color),
    typeof(LivenessIndicatorBase),
    new PropertyMetadata(Color.FromRgb(0x4D, 0xD8, 0xFF), OnVisualChanged));

  /// <summary>
  /// Base color of the comet.
  /// </summary>
  public Color Color {
  ...
  /// <summary>
  /// Corner radii of the traced path. If left unset, a nearby Border's CornerRadius is adopted 
  /// automatically (see <see cref="ResolveCornerRadius"/>).
  /// </summary>
  ...
  /// <summary>
  /// Corner radii of the traced path. If left unset, a nearby Border's
  /// CornerRadius is adopted automatically (see <see cref="ResolveCornerRadius"/>).
  /// </summary>
  ...
  /// <summary>
  /// Length (px) of the bright head / core.
  /// </summary>
  ...
  /// <summary>
  /// Length (px) of the fading tail behind the head.
  /// </summary>
  ...
  /// <summary>
  /// Number of segments to use for the tail. More segments = smoother fade, but more rendering cost.
  /// </summary>
  ...
  /// <summary>
  /// Resolution of the tail. Interpreted per subclass (layered stroke
  /// copies for the dashed variant, sampled dots for the Lite variant).
  /// </summary>
  ...
  /// <summary>
  /// Seconds for the head to travel once around the perimeter.
  /// </summary>
  ...
  /// <summary>
  /// Number of equally spaced comets. 1 = a single head, 2 = two heads opposite each other, etc.
  /// </summary>
  ...
  /// <summary>
  /// Number of equally spaced comets.
  /// </summary>
  ...
  /// <summary>
  /// Extra inward offset of the traced path from the bounds (beyond half the stroke).
  /// </summary>
  ...
  /// <summary>
  /// Add a soft glow halo around the head.
  /// </summary>
  ...
  /// <summary>
  /// Draw a faint full outline so the travel path is always visible.
  /// </summary>
  ...
  /// <summary>
  /// When false, the animation is paused and the indicator is drawn static (head at start position).
  /// </summary>
  ...
  /// <summary>
  /// Cap the animation timeline frame rate (fps). 0 = uncapped (default 60).
  /// </summary>
  ...
  /// useful when many indicators run at once.
  /// </summary>
  ...
  /// <summary>
  /// Called whenever a visual-affecting property changes, to rebuild the visual tree and restart the animation.
  /// </summary>
  ...
  /// <summary>
  /// In the common "Grid -> Border + overlay" (or Border -> indicator) layout the indicator's corners just 
  /// repeat the Border's. So if the caller never set CornerRadius explicitly, adopt a nearby Border's 
  /// CornerRadius instead of the default - one place to change the shape.
  /// </summary>
  ...
  private Border? FindAmbientBorder() {
    ...
    if (parent is Border nested) {                  // indicator inside the Border
      return nested;            
    }
  ...
  /// <summary>
  /// Clamp the corner radii to the maximum allowed by the width and height of the rectangle.
  /// </summary>
  ...
  /// <summary>
  /// Compute the perimeter of a rectangle with rounded corners, given the width, height, and corner radii.
  /// </summary>
  /// <param name="w">w</param>
  /// <param name="h">h</param>
