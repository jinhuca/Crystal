...
/// <summary>
/// Selects how a <see cref="PerformanceGraph"/> colors its <see cref="DisplayMode.Dot"/> dots.
/// </summary>
public enum DotColorMode {
  /// <summary>
  /// Every dot uses <see cref="PerformanceGraph.DotColor"/>. Renders through one
  ...
  /// <summary>
  /// Each dot is colored by which of nine fixed value-bands its row falls in (see
  ...
  /// default, so an unconfigured graph keeps its original green→red gauge look.
  /// </summary>
  Banded
}
