...
{
  public class CrystalApplicationSetup : IDisposable
  {
    public CrystalApplication Application { get; set; }

    public CrystalApplicationSetup()
    {
      ContainerLocator.ResetContainer();
      Application = new CrystalApplication();
  ...
  public class CrystalApplicationBaseFixture : IClassFixture<CrystalApplicationSetup>
  {
    CrystalApplication application = null;

    public CrystalApplicationBaseFixture(CrystalApplicationSetup setup)
    {
  ...
  public class CrystalApplication : CrystalApplicationBase
  {
