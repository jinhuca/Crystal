...
{
  public class CrystalBootstapperSetup : IDisposable
  {
    public CrystalBootstrapper Bootstrapper { get; set; }

    public CrystalBootstapperSetup()
    {
      ContainerLocator.ResetContainer();
      Bootstrapper = new CrystalBootstrapper();
      Bootstrapper.Run();
    }
  ...
  public class CrystalBootstapperBaseFixture : IClassFixture<CrystalBootstapperSetup>
  {
    CrystalBootstrapper bootstrapper = null;

    public CrystalBootstapperBaseFixture(CrystalBootstapperSetup setup)
    {
  ...
  public class CrystalBootstrapper : CrystalBootstrapperBase
  {
