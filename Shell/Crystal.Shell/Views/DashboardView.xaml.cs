...
public partial class DashboardView : UserControl {
  ...
  /// </summary>
  public GridLength CpuDefault {  get; } = new(1.1, GridUnitType.Star);

  /// <summary>
  /// Default row heights, kept in one place so ResetLayout and the XAML stay in sync.
  /// </summary>
  public GridLength GpuDefault {  get; } = new(1.1, GridUnitType.Star);
  ...
  /// </summary>
  public GridLength BottomDefault {  get; } = new(0.9, GridUnitType.Star);
