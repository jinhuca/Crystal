...
public class RegionAdapterMappings
{
  ...
  public void RegisterMapping(Type controlType, IRegionAdapter adapter)
  {
    ...
    {
      throw new InvalidOperationException(Format(MappingExistsException, controlType.Name));
    }
  ...
  public IRegionAdapter GetMapping(Type controlType)
  {
    ...
    throw new KeyNotFoundException(Format(NoRegionAdapterException, controlType));
  }
