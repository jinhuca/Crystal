...
namespace Crystal
{
	...
	public sealed class ModuleConfigurationElementCollection : ConfigurationElementCollection
	{
		/// <summary>
		...
		public ModuleConfigurationElement this[int index] => BaseGet(index) as ModuleConfigurationElement;
		...
		public bool Contains(string moduleName) => BaseGet(moduleName) != null;
