...
namespace Crystal
{
	...
	public static class IModuleCatalogCommonExtensions
	{
		...
		/// <param name="catalog">Catalog.</param>
		/// <returns></returns>
		public static ModuleState GetModuleState<T>(this IModuleCatalog catalog) where T : IModule
		...
		/// <param name="catalog">Catalog.</param>
		/// <typeparam name="T">The <see cref="IModule"/> to check.</typeparam>
		public static bool IsInitialized<T>(this IModuleCatalog catalog) where T : IModule
