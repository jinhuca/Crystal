...
namespace Crystal
{
	...
	public class DialogService : IDialogService
	{
		...
		protected virtual void ConfigureDialogWindowEvents(IDialogWindow dialogWindow, Action<IDialogResult> callback)
		{
			...
			void LoadedHandler(object o, RoutedEventArgs routedEventArgs)
			{
			...
			void ClosingHandler(object _, CancelEventArgs e)
			{
			...
			void ClosedHandler(object? o, EventArgs eventArgs)
			{
