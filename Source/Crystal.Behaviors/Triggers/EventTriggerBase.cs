...
namespace Crystal.Behaviors
{
  ...
  public abstract class EventTriggerBase : TriggerBase
  {
    ...
    public static readonly DependencyProperty SourceObjectProperty = DependencyProperty.Register(
      ...
      new PropertyMetadata(new PropertyChangedCallback(OnSourceObjectChanged)));
    ...
    protected sealed override Type AssociatedObjectTypeConstraint
    {
      get
      {
        ...
        return attributes[typeof(TypeConstraintAttribute)] is TypeConstraintAttribute typeConstraintAttribute
            ? typeConstraintAttribute.Constraint
    ...
    /// <summary>
    /// Gets or sets the target object. If TargetObject is not set, the target will look for the object specified by TargetName. 
    /// If an element referred to by TargetName cannot be found, the target will default to the AssociatedObject. This is a dependency property.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the name of the element this EventTriggerBase listens for as a source. If the name is not set or cannot be resolved, 
    /// the AssociatedObject will be used.  This is a dependency property.
    /// </summary>
    ...
    public object Source
    {
      get
      {
        object source = AssociatedObject;
    ...
    protected override void OnAttached()
    {
      ...
      base.OnAttached();
      DependencyObject newHost = AssociatedObject;
    ...
    protected override void OnDetaching()
    {
      ...
      FrameworkElement oldElement = AssociatedObject as FrameworkElement;
