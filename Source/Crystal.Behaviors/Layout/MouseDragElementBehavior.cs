...
namespace Crystal.Behaviors
{
  ...
  public class MouseDragElementBehavior : Behavior<FrameworkElement>
  {
    ...
    private Rect ElementBounds
    {
      get
      {
        Rect layoutRect = ExtendedVisualStateManager.GetLayoutRect(AssociatedObject);
    ...
    internal void StartDrag(Point positionInElementCoordinates)
    {
      ...
      AssociatedObject.AddHandler(UIElement.MouseLeftButtonUpEvent, new MouseButtonEventHandler(OnMouseLeftButtonUp), false /* handledEventsToo */);
    }
    ...
    {
      AssociatedObject.AddHandler(UIElement.MouseLeftButtonDownEvent, new MouseButtonEventHandler(OnMouseLeftButtonDown), false /* handledEventsToo */);
    }
