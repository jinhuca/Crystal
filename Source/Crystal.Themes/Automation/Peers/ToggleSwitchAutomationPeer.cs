...
namespace Crystal.Themes.Automation.Peers
{
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="T:Crystal.Themes.Automation.Peers.ToggleSwitchAutomationPeer" /> class.</summary>
        /// <param name="owner">The <see cref="T:Crystal.Themes.Controls.ToggleSwitch" /> associated with this <see cref="T:Crystal.Themes.Automation.Peers.ToggleSwitchAutomationPeer" />.</param>
