  ...
  [TemplatePart(Name = ElementButton, Type = typeof(Button))]
    ...
    public abstract class TimePickerBase : Control
    {
        ...
        public bool IsClockVisible
        {
            ...
            set => SetValue(IsClockVisibleProperty, BooleanBoxes.Box(value));
        }
        ...
        public bool IsDatePickerVisible
        {
            ...
            protected set => SetValue(IsDatePickerVisiblePropertyKey, BooleanBoxes.Box(value));
        }
        ...
        {
            SetCurrentValue(SourceHoursAmPmComparerProperty, new AmPmComparer());
        ...
        protected virtual void ClockSelectedTimeChanged()
        {
            ...
            SetCurrentValue(SelectedDateTimeProperty, date.Date + time);
        }
