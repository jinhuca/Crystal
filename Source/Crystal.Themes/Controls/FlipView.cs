...
public class FlipView : Selector
{
  ...
  public bool MouseHoverBorderEnabled
  {
    ...
    set => SetValue(MouseHoverBorderEnabledProperty, BooleanBoxes.Box(value));
  }
  ...
  public bool ShowIndex
  {
    ...
    set => SetValue(ShowIndexProperty, BooleanBoxes.Box(value));
  }
  ...
  public bool CircularNavigation
  {
    ...
    set => SetValue(CircularNavigationProperty, BooleanBoxes.Box(value));
  }
  ...
  public bool IsBannerEnabled
  {
    ...
    set => SetValue(IsBannerEnabledProperty, BooleanBoxes.Box(value));
  }
  ...
  public bool IsNavigationEnabled
  {
    ...
    set => SetValue(IsNavigationEnabledProperty, BooleanBoxes.Box(value));
  }
  ...
  private void ChangeBannerText(object? value = null)
  {
    if (IsBannerEnabled)
    {
      var newValue = value ?? (object?)BannerText;
      if (newValue is null
