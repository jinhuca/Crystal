...
namespace Crystal.Themes.Controls
{
  ...
  public class CustomValidationPopup : Popup
  {
    ...
    private CrystalContentControl? crystalContentControl;
    ...
    private void CustomValidationPopup_Loaded(object? sender, RoutedEventArgs e)
    {
      ...
      if (crystalContentControl != null)
      {
        crystalContentControl.TransitionStarted -= OnTransitionStarted;
        crystalContentControl.TransitionCompleted -= OnTransitionCompleted;
      }

      crystalContentControl = adornedElement.TryFindParent<CrystalContentControl>();
      if (crystalContentControl != null)
      {
        canShow = !crystalContentControl.TransitionsEnabled || !crystalContentControl.IsTransitioning;
        crystalContentControl.TransitionStarted += OnTransitionStarted;
        crystalContentControl.TransitionCompleted += OnTransitionCompleted;
      }
