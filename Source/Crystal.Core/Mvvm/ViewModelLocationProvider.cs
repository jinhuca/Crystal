...
namespace Crystal
{
	...
	public static class ViewModelLocationProvider
	{
		...
		private static object GetViewModelForView(object view)
		{
			...
			return _factories?.ContainsKey(viewKey) == true ? _factories[viewKey]() : null;       // Mapping of view models base on view type (or instance) goes here
		}
		...
		private static Type GetViewModelTypeForView(Type view)
		{
			...
			return _typeFactories?.ContainsKey(viewKey) == true ? _typeFactories[viewKey] : null;
    }
