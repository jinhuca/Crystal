...
namespace Crystal
{
	...
	public class BackgroundEventSubscription : EventSubscription
	{
		...
		/// A reference to a delegate of type <see cref="System.Action"/>.
		/// </param>
		/// <exception cref="ArgumentNullException">
		/// When <paramref name="actionReference"/> or <see paramref="filterReference"/> are <see langword="null" />.
		/// </exception>
		/// <exception cref="ArgumentException">
		/// When the target of <paramref name="actionReference"/> is not of type <see cref="System.Action"/>.
		/// </exception>
	...
	/// The type to use for the generic <see cref="System.Action{TPayload}"/> and <see cref="Predicate{TPayload}"/> types.
	/// </typeparam>
	public class BackgroundEventSubscription<TPayload> : EventSubscription<TPayload>
	{
		...
		/// </summary>
		/// <param name="actionReference">
		/// A reference to a delegate of type <see cref="System.Action{TPayload}"/>.
		/// </param>
		/// <param name="filterReference">
		/// A reference to a delegate of type <see cref="Predicate{TPayload}"/>.
		/// </param>
		/// <exception cref="ArgumentNullException">
		/// When <paramref name="actionReference"/> or <see paramref="filterReference"/> are <see langword="null" />.
		/// </exception>
		...
		/// </param>
		/// <param name="argument">
		/// The payload to pass <paramref name="action"/> while invoking it.
		/// </param>
