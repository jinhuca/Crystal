  ...
  public class EventSubscription : IEventSubscription
	{
		...
		public EventSubscription(IDelegateReference actionReference)
		{
			...
			{
				throw new ArgumentException(Format(InvalidDelegateRerefenceTypeException, typeof(Action).FullName), nameof(actionReference));
			}
	...
	public class EventSubscription<TPayload> : IEventSubscription
	{
		...
		public EventSubscription(IDelegateReference actionReference, IDelegateReference filterReference)
		{
			...
			{
				throw new ArgumentException(Format(InvalidDelegateRerefenceTypeException, typeof(Action<TPayload>).FullName), nameof(actionReference));
			}
			...
			{
				throw new ArgumentException(Format(InvalidDelegateRerefenceTypeException, typeof(Predicate<TPayload>).FullName), nameof(filterReference));
			}
