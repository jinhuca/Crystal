...
public abstract class DelegateCommandBase : ICommand, IActiveAware
{
  ...
  /// <summary>
  /// Raises <see cref="ICommand.CanExecuteChanged"/> so every command invoker can re-query <see cref="ICommand.CanExecute"/>.
  /// </summary>
  ...
  /// <summary>
  /// Observes a property that implements INotifyPropertyChanged, and automatically calls DelegateCommandBase.RaiseCanExecuteChanged
  ...
  protected internal void ObservesPropertyInternal<T>(Expression<Func<T>> propertyExpression)
  {
    ...
    {
      throw new ArgumentException($@"{propertyExpression} {PropertyAlreadyObserved}", nameof(propertyExpression));
    }
